...
theme.loadEditor = function()
  ...
  if vim.g.nord_borders then
    ...
    editor.WinSeparator = { fg = nord.nord1_gui }
  else
    editor.VertSplit = { fg = nord.nord1_gui }
    editor.WinSeparator = { fg = nord.nord1_gui }
  end
...
theme.loadPlugins = function()
  ...
  local plugins = {
    ...
    -- snacks.nvim
    SnacksBackdrop_ = { fg = nord.nord4_gui },
    SnacksDashboard = { fg = nord.nord4_gui },
    SnacksDashboardNormal = { fg = nord.nord4_gui, bg = nord.float },
    SnacksDashboardTerminal = { fg = nord.nord4_gui },
    SnacksDebug = { fg = nord.nord4_gui },
    SnacksDebugIndent = { fg = nord.nord3_gui },
    SnacksDebugPrint = { fg = nord.nord4_gui },
    SnacksDim = { fg = nord.nord3_gui },
    SnacksImage = { fg = nord.nord4_gui },
    SnacksImageAnchor = { fg = nord.nord9_gui },
    SnacksImageLoading = { fg = nord.nord8_gui },
    SnacksImageMath = { fg = nord.nord7_gui },
    SnacksImageSpinner = { fg = nord.nord8_gui },
    SnacksIndent = { fg = nord.nord3_gui },
    SnacksIndent1 = { fg = nord.nord15_gui },
    SnacksIndent2 = { fg = nord.nord13_gui },
    SnacksIndent3 = { fg = nord.nord11_gui },
    SnacksIndent4 = { fg = nord.nord7_gui },
    SnacksIndent5 = { fg = nord.nord8_gui },
    SnacksIndent6 = { fg = nord.nord15_gui },
    SnacksIndent7 = { fg = nord.nord13_gui },
    SnacksIndent8 = { fg = nord.nord11_gui },
    SnacksIndentChunk = { fg = nord.nord4_gui },
    SnacksIndentScope = { fg = nord.nord10_gui },
    SnacksIndentUnderline_ = { fg = nord.nord3_gui },
    SnacksInput = { fg = nord.nord4_gui },
    SnacksInputBorder = { fg = nord.nord4_gui },
    SnacksInputIcon = { fg = nord.nord8_gui },
    SnacksInputNormal = { fg = nord.nord4_gui, bg = nord.float },
    SnacksInputTitle = { fg = nord.nord4_gui },
    SnacksNormal = { fg = nord.nord4_gui },
    SnacksNormalNC = { fg = nord.nord4_gui },
    SnacksNotifier = { fg = nord.nord4_gui },
    SnacksNotifierHistory = { fg = nord.nord4_gui },
    SnacksNotifierHistoryTitle = { fg = nord.nord4_gui },
    SnacksNotifierMinimal = { fg = nord.nord4_gui },
    SnacksPicker = { fg = nord.nord4_gui },
    SnacksPickerAuEvent = { fg = nord.nord9_gui },
    SnacksPickerAuGroup = { fg = nord.nord9_gui },
    SnacksPickerAuPattern = { fg = nord.nord14_gui },
    SnacksPickerBold = { fg = nord.nord4_gui, style = bold },
    SnacksPickerBox = { fg = nord.nord4_gui },
    SnacksPickerBufFlags = { fg = nord.nord9_gui },
    SnacksPickerBufNr = { fg = nord.nord15_gui },
    SnacksPickerCmd = { fg = nord.nord8_gui },
    SnacksPickerCode = { fg = nord.nord14_gui },
    SnacksPickerCol = { fg = nord.nord15_gui },
    SnacksPickerComment = { fg = nord.nord3_gui_bright },
    SnacksPickerDelim = { fg = nord.nord8_gui },
    SnacksPickerDesc = { fg = nord.nord7_gui },
    SnacksPickerDiagnosticCode = { fg = nord.nord15_gui },
    SnacksPickerDiagnosticSource = { fg = nord.nord9_gui },
    SnacksPickerDimmed = { fg = nord.nord3_gui },
    SnacksPickerDir = { fg = nord.nord7_gui },
    SnacksPickerDirectory = { fg = nord.nord7_gui },
    SnacksPickerFile = { fg = nord.nord4_gui },
    SnacksPickerGitBranch = { fg = nord.nord10_gui },
    SnacksPickerGitBranchCurrent = { fg = nord.nord10_gui, style = bold },
    SnacksPickerGitBreaking = { fg = nord.nord11_gui },
    SnacksPickerGitCommit = { fg = nord.nord9_gui },
    SnacksPickerGitDate = { fg = nord.nord8_gui },
    SnacksPickerGitDetached = { fg = nord.nord15_gui },
    SnacksPickerGitIssue = { fg = nord.nord14_gui },
    SnacksPickerGitMsg = { fg = nord.nord4_gui },
    SnacksPickerGitScope = { fg = nord.nord9_gui },
    SnacksPickerGitStatus = { fg = nord.nord4_gui },
    SnacksPickerGitStatusAdded = { fg = nord.nord14_gui },
    SnacksPickerGitStatusCopied = { fg = nord.nord13_gui },
    SnacksPickerGitStatusDeleted = { fg = nord.nord11_gui },
    SnacksPickerGitStatusModified = { fg = nord.nord13_gui },
    SnacksPickerGitStatusRenamed = { fg = nord.nord13_gui },
    SnacksPickerGitStatusStaged = { fg = nord.nord14_gui },
    SnacksPickerGitStatusUnmerged = { fg = nord.nord11_gui },
    SnacksPickerGitStatusUntracked = { fg = nord.nord15_gui },
    SnacksPickerGitType = { fg = nord.nord9_gui },
    SnacksPickerIcon = { fg = nord.nord8_gui },
    SnacksPickerIconCategory = { fg = nord.nord9_gui },
    SnacksPickerIconName = { fg = nord.nord8_gui },
    SnacksPickerIconSource = { fg = nord.nord9_gui },
    SnacksPickerIdx = { fg = nord.nord15_gui },
    SnacksPickerInput = { fg = nord.nord4_gui },
    SnacksPickerInputSearch = { fg = nord.nord5_gui },
    SnacksPickerItalic = { fg = nord.nord4_gui, style = italic },
    SnacksPickerKeymapLhs = { fg = nord.nord9_gui },
    SnacksPickerKeymapMode = { fg = nord.nord10_gui },
    SnacksPickerKeymapNowait = { fg = nord.nord15_gui },
    SnacksPickerKeymapRhs = { fg = nord.nord7_gui },
    SnacksPickerLabel = { fg = nord.nord10_gui },
    SnacksPickerLink = { fg = nord.nord14_gui },
    SnacksPickerLinkBroken = { fg = nord.nord11_gui },
    SnacksPickerList = { fg = nord.nord4_gui },
    SnacksPickerListCursorLine = { fg = nord.nord4_gui, bg = nord.nord2_gui },
    SnacksPickerLspAttached = { fg = nord.nord14_gui },
    SnacksPickerLspAttachedBuf = { fg = nord.nord14_gui },
    SnacksPickerLspDisabled = { fg = nord.nord11_gui },
    SnacksPickerLspEnabled = { fg = nord.nord14_gui },
    SnacksPickerLspUnavailable = { fg = nord.nord15_gui },
    SnacksPickerManDesc = { fg = nord.nord7_gui },
    SnacksPickerManPage = { fg = nord.nord4_gui },
    SnacksPickerManSection = { fg = nord.nord9_gui },
    SnacksPickerMatch = { fg = nord.nord5_gui, style = bold },
    SnacksPickerNotificationMessage = { fg = nord.nord4_gui },
    SnacksPickerPathHidden = { fg = nord.nord4_gui },
    SnacksPickerPathIgnored = { fg = nord.nord4_gui },
    SnacksPickerPickWin = { fg = nord.nord4_gui },
    SnacksPickerPreview = { fg = nord.nord4_gui },
    SnacksPickerPreviewCursorLine = { fg = nord.nord4_gui, bg = nord.nord1_gui },
    SnacksPickerPrompt = { fg = nord.nord4_gui },
    SnacksPickerRegister = { fg = nord.nord9_gui },
    SnacksPickerRow = { fg = nord.nord4_gui },
    SnacksPickerSearch = { fg = nord.nord5_gui },
    SnacksPickerSelected = { fg = nord.nord4_gui, bg = nord.nord2_gui },
    SnacksPickerSpecial = { fg = nord.nord8_gui },
    SnacksPickerSpinner = { fg = nord.nord8_gui },
    SnacksPickerTime = { fg = nord.nord8_gui },
    SnacksPickerToggle = { fg = nord.nord9_gui },
    SnacksPickerTotals = { fg = nord.nord3_gui },
    SnacksPickerTree = { fg = nord.nord3_gui },
    SnacksPickerUndoAdded = { fg = nord.nord14_gui },
    SnacksPickerUndoCurrent = { fg = nord.nord10_gui },
    SnacksPickerUndoRemoved = { fg = nord.nord11_gui },
    SnacksPickerUndoSaved = { fg = nord.nord9_gui },
    SnacksPickerUnselected = { fg = nord.nord4_gui },
    SnacksProfiler = { fg = nord.nord4_gui },
    SnacksProfilerBadge = { fg = nord.nord9_gui },
    SnacksProfilerBadgeInfo = { fg = nord.nord10_gui },
    SnacksProfilerBadgeTrace = { fg = nord.nord15_gui },
    SnacksProfilerHot = { fg = nord.nord11_gui },
    SnacksProfilerIcon = { fg = nord.nord8_gui },
    SnacksProfilerIconInfo = { fg = nord.nord10_gui },
    SnacksProfilerLoaded = { fg = nord.nord14_gui },
    SnacksProfilerStarted = { fg = nord.nord14_gui },
    SnacksProfilerStopped = { fg = nord.nord11_gui },
    SnacksScratch = { fg = nord.nord4_gui },
    SnacksScratchDesc = { fg = nord.nord7_gui },
    SnacksScratchFooter = { fg = nord.nord3_gui },
    SnacksScratchKey = { fg = nord.nord9_gui },
    SnacksScratchTitle = { fg = nord.nord4_gui },
    SnacksStatusColumn = { fg = nord.nord4_gui },
    SnacksStatusColumnMark = { fg = nord.nord10_gui },
    SnacksWinBar = { fg = nord.nord4_gui },
    SnacksWinBarNC = { fg = nord.nord4_gui },
    SnacksWinKey = { fg = nord.nord9_gui },
    SnacksWinKeyDesc = { fg = nord.nord7_gui },
    SnacksWinKeySep = { fg = nord.nord3_gui },
    SnacksZen = { fg = nord.nord4_gui },
    SnacksZenIcon = { fg = nord.nord8_gui },
  }
  -- Options:
